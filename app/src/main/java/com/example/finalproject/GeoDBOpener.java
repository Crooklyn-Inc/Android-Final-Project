...
public class GeoDBOpener extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        StringBuilder sb = new StringBuilder("CREATE TABLE " + TABLE_NAME + " (" + GeoDataSource.ATTR_MAP.get(0).string + " INTEGER PRIMARY KEY AUTOINCREMENT");

        for (int i = 1; i < GeoDataSource.ATTR_MAP.size(); i++) {
